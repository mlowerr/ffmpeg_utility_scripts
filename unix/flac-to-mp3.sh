...
# ======================================
# Converts .flac audio files in the current directory (or recursively with -r)
...
process_file() {
    ...
    base_name="${base_name%.[Ff][Ll][Aa][Cc]}"
...
if [[ "$total_files" -eq 0 ]]; then
    echo "No eligible FLAC files found to process."
    exit 0
fi
